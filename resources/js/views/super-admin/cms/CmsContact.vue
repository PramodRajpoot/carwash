<template>
  <div class="dash-content-body">
    <div class="dash-header-bar mb-3">
      <h2>CMS: Contact Page</h2>
      <p class="text-muted text-sm mt-1">Manage the content for the "Contact Page" on the public website.</p>
    </div>
    ...
    <div v-else class="grid grid-2 gap-4">
      ...
      <div class="glass-card p-4" style="background: var(--bg-primary);">
        ...
        <form @submit.prevent="updateContactPage">
          <div class="mb-3">
...
export default {
  ...
  methods: {
    ...
    async updateContactPage() {
      ...
      this.error = '';
      try {
        const response = await axios.post('/api/super-admin/cms/contact', this.form);

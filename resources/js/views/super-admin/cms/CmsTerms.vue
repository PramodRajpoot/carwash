<template>
  <div class="dash-content-body">
    <div class="dash-header-bar mb-3">
      <h2>CMS: Terms & Conditions</h2>
      <p class="text-muted text-sm mt-1">Manage the content for the "Terms & Conditions" page on the public website.</p>
    </div>
    ...
    <div v-else class="grid grid-2 gap-4">
      ...
      <div class="glass-card p-4" style="background: var(--bg-primary);">
        ...
        <form @submit.prevent="updateTermsAndConditions">
          <div class="mb-3">
...
export default {
  ...
  methods: {
    ...
    async updateTermsAndConditions() {
      ...
      this.error = '';
      try {
        const response = await axios.post('/api/super-admin/cms/terms', this.form);
